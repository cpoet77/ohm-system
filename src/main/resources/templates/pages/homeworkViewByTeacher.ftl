                ...
                <div class="box box-solid">
                    <div class="box-header with-border">
                        <div class="btn-group-sm">
                            <button type="button" onclick="NS.to('/publishHomework?courseGroup=${courseGroup.id}')"
                                    class="btn btn-success btn-sm">发布作业
                            </button>
                            <button type="button" class="btn bg-orange btn-sm">学生列表</button>
                        </div>
                        <hr>
                        <form>
                    ...
                    <div class="box-body">
                        <div>
                            <div type="button" class="btn btn-block btn-social btn-default btn-lg">
                                ...
                                <div class="" style="float:left;font-size:12px;">
                                    <span>共 </span>
                                    <span>1</span>
                                    <span>人参与</span>
                                    <span>|</span>
